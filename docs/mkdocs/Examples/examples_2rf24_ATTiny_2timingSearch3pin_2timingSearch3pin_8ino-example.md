---
title: examples/rf24_ATTiny/timingSearch3pin/timingSearch3pin.ino
...
This sketch can be used to determine the best settle time values to use for [RF24::csDelay](/Classes/classRF24/#variable-csdelay) in [RF24::csn()](/Classes/classRF24/#function-csn) (private function). 
The settle time values used here are 100/20. However, these values depend on the actual used RC combiniation and voltage drop by LED. The intermediate results are written to TX (PB3, pin 2 &ndash; using Serial).
...
_Filename: examples/rf24_ATTiny/timingSearch3pin/timingSearch3pin.ino_
